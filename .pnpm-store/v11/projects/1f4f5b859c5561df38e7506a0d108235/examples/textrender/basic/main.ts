...
export function configureBasicText(context: TextDemoContext): void {
  ...
  const entries = [
    {
      ...
      color: [0.2, 0.65, 0.48] as const,
      text: "Pump A-12",
      fontSize: 20,
      textColor: "#fff4c2",
      labelBackground: { backgroundColor: "#143e35", borderColor: "#4de0ae", borderWidth: 2, borderRadius: 8, padding: 9 }
    },
    {
      name: "Coolant",
      position: [0, 0.4, 0] as const,
      color: [0.18, 0.5, 0.68] as const,
      text: "Coolant 18.2 °C",
      fontSize: 26,
      textColor: "#ffffff",
      labelBackground: { backgroundColor: "#103c64", borderColor: "#79d5ff", borderWidth: 2, borderRadius: 14, padding: 13 }
    },
    {
      name: "Warning",
      position: [3, -0.15, 0] as const,
      color: [0.72, 0.43, 0.18] as const,
      text: "Pressure high",
      fontSize: 18,
      textColor: "#72e6ff",
      labelBackground: {}
  ...
  for (const [index, entry] of entries.entries()) {
    ...
    createLabel(context.layer, {
      ...
      zIndex: index,
      style: { color: entry.textColor, fontSize: entry.fontSize, ...entry.labelBackground }
    });
  }
  createLabel(context.layer, {
