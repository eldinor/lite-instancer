import type { InstanceTransformInput, Mat4, QuatLike, Vec3Like } from "./types.js";
...
/** Multiply two column-major matrices. */
export function multiplyMat4(left: Mat4, right: Mat4, out: Mat4 = new Float32Array(16)): Mat4 {
