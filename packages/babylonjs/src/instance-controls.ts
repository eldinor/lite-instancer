...
/** Validate and freeze tooling metadata without importing or registering an editor framework. */
...
/** Standard engine-neutral descriptor facade for Babylon.js VAT instances. */
...
export type VatInstanceControlName = "clip" | "speed" | "phase" | "visible" | "tint";

/** Stable-ID value adapter; creating it performs no writes or renderer registration. */
export interface VatInstanceControlAdapter {
  readonly controls: InstanceControlMap;
  get(id: InstanceId, control: VatInstanceControlName): unknown;
  set(id: InstanceId, control: VatInstanceControlName, value: unknown): boolean;
}
