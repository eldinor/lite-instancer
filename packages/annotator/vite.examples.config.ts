  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        textRendererBackgroundModes: resolve(examplesRoot, "textrender/background-modes/index.html"),
        ...
        textRendererLabelBenchmark: resolve(examplesRoot, "textrender/label-benchmark/index.html"),
