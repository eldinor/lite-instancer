...
export const demos: readonly DemoEntry[] = Object.freeze([
  ...
  demo("textrender-background-modes", "GPU background modes", "Compare default nine-slice cards with the opt-in one-sprite rounded-card renderer.", "gpu", "textrender/background-modes/", "labelBackgroundMode"),
  ...
  demo("textrender-label-benchmark", "GPU label benchmark", "Run deterministic static, moving, shaping, collision, z-bucket, and background-mode suites through 1,000 labels.", "gpu", "textrender/label-benchmark/", "p50 + p95 + p99"),
